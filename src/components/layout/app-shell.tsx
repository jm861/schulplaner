...
export function AppShell({ children }: AppShellProps) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-100 via-slate-50 to-white text-slate-900 dark:from-slate-950 dark:via-slate-900 dark:to-slate-950 dark:text-slate-100" style={{ position: 'relative' }}>
      <div className="mx-auto flex min-h-screen w-full max-w-[100rem] flex-col gap-6 px-3 py-4 pb-28 sm:gap-8 sm:px-6 sm:py-6 sm:pb-12 md:gap-10 md:px-8 md:py-8 md:pb-12 lg:gap-12 lg:px-20 xl:px-24 2xl:px-28 lg:py-16">
