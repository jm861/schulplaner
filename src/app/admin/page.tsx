/**
 * Admin Page - Apple-like Design
 * Manage users and system settings for admins and operators
 */
...
import { Shield, Users, LogOut, Eye, EyeOff, Trash2, Edit2, X } from 'lucide-react';
  ...
  return (
    <div className="space-y-6 pb-20 lg:pb-6">
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
        ...
        <Card>
          <CardHeader className="pb-3">
            <CardDescription>{t('admin.loggedInAs')}</CardDescription>
        ...
        {kvStatus && (
          <Card>
            <CardHeader className="pb-3">
              <CardDescription>Upstash Status</CardDescription>
              <div className="flex items-center gap-2 mt-2">
                ...
                <CardTitle className="text-xs font-normal">
                  {kvStatus.connected
                    ? `Connected (${kvStatus.userCount || 0} users)`
                    : kvStatus.configured
            ...
            {recentRegistrations.length === 0 ? (
              ...
              recentRegistrations.map((u) => {
                ...
                return (
                  <Card
                    key={u.id}
                    variant={isRecent ? 'elevated' : 'default'}
                    className={isRecent ? 'border-green-200 bg-green-50 dark:border-green-800 dark:bg-green-950/30' : ''}
                  >
                    <CardContent className="pt-4">
                      <div className="flex items-start justify-between gap-4">
                        <div className="flex-1 min-w-0">
                          ...
                          <p className="text-xs text-gray-600 dark:text-gray-400 truncate mt-1">{u.email}</p>
                        ...
                        {editingRole === u.id ? (
                          <div className="flex flex-col gap-2 w-full sm:w-auto">
                            <select
                              ...
                              className="rounded-xl border border-gray-300 bg-white px-3 py-2 text-xs font-medium text-gray-900 transition-all hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-blue-500 dark:border-gray-700 dark:bg-gray-800 dark:text-white dark:hover:bg-gray-700"
                            >
            ...
            {users.length === 0 ? (
              ...
              users.map((u) => {
                ...
                return (
                  <Card
                    key={u.id}
                    variant={isRecentlyActive ? 'elevated' : 'default'}
                    className={isRecentlyActive ? 'border-green-200 bg-green-50 dark:border-green-800 dark:bg-green-950/30' : ''}
                  >
                    <CardContent className="pt-4">
                      <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
                        <div className="flex-1 min-w-0">
